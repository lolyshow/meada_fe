...
const QuickViewModal = () => {
  ...
  const handleAddToCart = async() => {
    ...
    const result = await dispatch(
      addToCart({ _id: product._id, count: quantity })
    );

    if (addToCart.fulfilled.match(result)) {
      console.log("added to cart from inside quick view")
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex font-medium text-white bg-[#afc946] py-3 px-7 rounded-md ease-out duration-200 hover:bg-[#505732]
                  `}
                >
                  Add to Carts
                </button>
