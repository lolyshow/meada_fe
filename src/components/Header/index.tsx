...
import { useAppDispatch, useAppSelector, selectUser, selectIsAuthenticated, selectCartItemCount, selectCartTotal } from "@/redux/store";
...
const Header = () => {
  ...
  // ── Fetch cart & categories on mount ─────────────────────────────────────
  useEffect(() => {
    if (isAuthenticated) {
      dispatch(fetchCart());
    }
  ...
  const categoryOptions = [
    ...
    ...categories.map((cat:any) => ({ label: cat.title, value: cat._id })),
  ];
  ...
  return (
    ...
    >
      <div className="w-full bg-[#afc946] mx-auto px-4 sm:px-7.5 xl:px-12 pb-4">
        {/* header top */}
        <div
          className={`flex flex-col lg:flex-row gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 ${
            stickyMenu ? "py-1" : "py-1"
          }`}
        >
          {/* header top left */}
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            ...
            <div className="max-w-[475px] mt-6 w-full">
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      name="search"
                      id="search"
                      placeholder="Search chicken, fish, beef..."
                      autoComplete="off"
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="font-medium text-custom-sm text-dark">(+234) 800-000-0000</p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-5">
                ...
                {isAuthenticated && user ? (
                  <div className="relative">
                    ...
                    >
                      <div className="w-8 h-8 rounded-full bg-blue flex items-center justify-center text-white font-semibold text-sm">
                    ...
                    {/* dropdown */}
                    {userMenuOpen && (
                      <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-3 py-2 z-50">
                        <Link
                          href="/my-account"
      ...
      {/* nav bottom bar */}
      <div className="border-t border-gray-3 bg-white">
